...
import { MapPin, Phone, AlertCircle, CheckCircle2, Lock, Unlock, User, Filter } from 'lucide-react';
...
export default function EnumeratorDashboard() {
  ...
  const handleAiAsk = async () => {
    return "This is your Field Copilot. I can translate questions, explain procedures, or help you log incomplete cases securely.";
  };
      ...
      <main className="page-content container">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p>Welcome, Agent 007. Assigned Area: <strong>Sector 4, Block B</strong></p>
          </div>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                fontSize: '0.85rem',
                fontWeight: '600',
                backgroundColor: filter === item.label ? 'var(--primary-color)' : 'white',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '2rem' }}>
            ...
            <div className="card" style={{ padding: '0', overflow: 'hidden' }}>
              <div className="flex justify-between items-center" style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid var(--border-color)', backgroundColor: 'var(--bg-main)' }}>
                <h2 style={{ margin: 0, fontSize: '1.15rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  <MapPin size={18} color="var(--primary-color)" /> Assigned Households ({filteredTasks.length})
                </h2>
                <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>PII Data Locked by Default</span>
              </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ 
                          ...
                          <div className="flex justify-between">
                            <div>
                              <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>Resident Name / Address</div>
                              <div style={{ fontWeight: '600' }}>{task.household}</div>
                            </div>
                            <div>
          ...
          <section>
            <GenAIAssistant 
              title="Field Copilot" 
              initialGreeting="Hi! I'm here to help. Note that personally identifiable information is hidden by default to comply with strict privacy regulations."
              onAsk={handleAiAsk}
            />
          </section>
        </div>
